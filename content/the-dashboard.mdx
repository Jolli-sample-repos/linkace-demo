...
The Dashboard is the first screen you see after logging into LinkAce. It displays the last few saved links, a mini form for adding a new link quickly, as well as some numeric stats of your link database.

![Preview of the Dashboard](https://www.linkace.org/media/screen/v2/dashboard.png)
